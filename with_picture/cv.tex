...
\item \textbf{Electronics PCB level design:} Full stack PCB design from schematic or device idea to SMT Assembly including Design for manufacturing (DFM). Embedded systems design (STM32,ESP32), DSP, SDR,  control systems engineering , DC-DC converters, drivers, analog electronics, RF, IOT stack, impedance matched design, audio design.
...
\begin{itemize}
\item \textbf{Electronics IC design:} Cadence virtuoso, SPICE, SPECTRE, Vivado.
\item \textbf{Electronics PCB design:} Altium designer, KiCad,LtSpice, STM32 cube IDE, Arduino IDE, PlatformIO.
...
[ Senior R\&D engineer][March 2022 to present]
   \begin{itemize}
      \item Development of FPGA based SMS and SHS memory testing solutions
   \end{itemize}

\cvsubsection{ \href{http://twin3d.pro}{Twin3d}}[LLC]
[ Leading electrical/software engineer, project manager, and network engineer][January 2021 to Feb 2022]
