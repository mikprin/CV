...
\begin{itemize}
   \item \textbf{Software engineering:} General experience of collaborative functional and object-oriented programming. Working with data and data analysis. Data visualization. Basics of web development. Digital signal processing. Embedded programming.
...
\begin{itemize}
   ...
   \item \textbf{DevOps and OS:} Docker, Ansible, Kubernetes, Linux (Centos,Debian based systems, Arch), GIT, filesystems, command line utilities (grep,find etc).
