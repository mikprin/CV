...
\item \textbf{Electronics PCB level design:} Full stack PCB design from schematic or device idea to SMT Assembly. Microcontrollers design (STM32,ESP32), DC-DC converters, drivers , analog electronics, RF, impedance matched design, audio effects design.
