...
\item \textbf{Computational and Machine Learning, computer vision:} Applied machine learning algorithms. General knowledge in ML framework programming. Data preprocessing and working with dataset. Optimization algorithms and basic CV algorithms.
