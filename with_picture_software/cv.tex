...
\begin{itemize}
   ...
   \item \textbf{Programming langauges:} Python, C/C++, bash, VerilogA, MATLAB, Simulink, SimScape, Verilog, VerilogA, SQL, gnuradio.
   \item \textbf{Frameworks:} FastApi, numpy, pandas, scipy, celery, PyTorch, sklearn, ansible API, threading, matplotlib (plotly), Qt, SQLAlchemy.
