...
\item \textbf{Mechanical skills:} Soldering (including 0403 SMD), Assembling and general mechanical engineering knowledge and experience. 3D slicing and Printing.
...
\item \textbf{Programming:} Python, C, bash, VerilogA, MATLAB, Simulink, Verilog.
