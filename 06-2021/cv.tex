...
\item \textbf{Electronics PCB level design:} DC-DC converters, microcontrollers, analog electronics, impedance matched design.
...
\item[Hobbies] Competition level social dancer (WCS, Hustle), Really love building and maintaning computers.
\end{description}
