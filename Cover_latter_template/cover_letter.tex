...
% Company Info
%====================
\def\hm{Katharina Dandorfer } % Hiring Manager Name, leave empty if unknown
\def\position{Electronics Development Engineer} % position
\def\company{Zühlke} % company
\def\source{zuehlke.com} % where was the posting found, "I found ____ "
