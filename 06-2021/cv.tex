...
[Data engineer][October 2022 to present]
   \begin{itemize}
      \item Development of custom mutation database query microservice engine "biom-calc" for BostonGene's R\&D software team. Also Integrated my work in k8s the cluster.
      \item Improving internal ML pipeline usability for production.
...
[Senior R\&D engineer][March 2022 to October 2022]
   \begin{itemize}
      ...
      \item Flow included development of Firmware, RTOS, and Linux software to contact custom generated RTL code for memory testing. Working with Zynq7000 and Zynq Ultrascale+ devices.
...
\cvsubsection{\href{https://mipt.ru/english/}{MIPT Neuromorphic computing systems lab}}[BS + MsC]
