...
\address{Address}{Dolgoprudny}{Moscow}% optional, remove / comment the line if not wanted; the "postcode city" and and "country" arguments can be omitted or provided empty
...
%-----       letter       ---------------------------------------------------------
% recipient data
\recipient{To The research laboratory Nikhef}{Motivational letter for PhD program}
\date{\today}
