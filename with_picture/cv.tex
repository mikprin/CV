...
\item \textbf{Electronics PCB and embedded design:} Altium designer, KiCad,LtSpice, STM32 cube IDE, Arduino IDE, PlatformIO, ESP-IDF.
...
\begin{itemize}
   ...
   \item Developed custom IOT solution to control 240 cameras, lights and 10 controlling computers and controllers with USB, UART, TCP, MQTT and SSH protocols.
