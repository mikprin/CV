...
% Company Info
%====================
\def\hm{ Talent Program hiring manager} % Hiring Manager Name, leave empty if unknown
\def\position{Electronics Development Engineer} % position
\def\company{Global Electrolux} % company
