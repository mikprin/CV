...
\item \textbf{System administration:} Advanced Linux administration, Firewall and network setup, containers management and automation, deployment of VPN and other server client oriented soft.
...
\item \textbf{Programming:} Python, C, bash, VerilogA, MATLAB, Simulink, SimScape, Git, Verilog.
